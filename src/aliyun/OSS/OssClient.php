<?php
namespace by\component\aliyun\OSS;

use by\component\aliyun\OSS\Core\MimeTypes;
use by\component\aliyun\OSS\Core\OssException;
use by\component\aliyun\OSS\Http\RequestCore;
use by\component\aliyun\OSS\Http\RequestCore_Exception;
use by\component\aliyun\OSS\Http\ResponseCore;
use by\component\aliyun\OSS\Model\CorsConfig;
use by\component\aliyun\OSS\Model\CnameConfig;
use by\component\aliyun\OSS\Model\LoggingConfig;
use by\component\aliyun\OSS\Model\LiveChannelConfig;
use by\component\aliyun\OSS\Model\LiveChannelInfo;
use by\component\aliyun\OSS\Model\LiveChannelListInfo;
use by\component\aliyun\OSS\Model\StorageCapacityConfig;
use by\component\aliyun\OSS\Result\AclResult;
use by\component\aliyun\OSS\Result\BodyResult;
use by\component\aliyun\OSS\Result\GetCorsResult;
use by\component\aliyun\OSS\Result\GetLifecycleResult;
use by\component\aliyun\OSS\Result\GetLocationResult;
use by\component\aliyun\OSS\Result\GetLoggingResult;
use by\component\aliyun\OSS\Result\GetRefererResult;
use by\component\aliyun\OSS\Result\GetStorageCapacityResult;
use by\component\aliyun\OSS\Result\GetWebsiteResult;
use by\component\aliyun\OSS\Result\GetCnameResult;
use by\component\aliyun\OSS\Result\HeaderResult;
use by\component\aliyun\OSS\Result\InitiateMultipartUploadResult;
use by\component\aliyun\OSS\Result\ListBucketsResult;
use by\component\aliyun\OSS\Result\ListMultipartUploadResult;
use by\component\aliyun\OSS\Model\ListMultipartUploadInfo;
use by\component\aliyun\OSS\Result\ListObjectsResult;
use by\component\aliyun\OSS\Result\ListPartsResult;
use by\component\aliyun\OSS\Result\PutSetDeleteResult;
use by\component\aliyun\OSS\Result\DeleteObjectsResult;
use by\component\aliyun\OSS\Result\CopyObjectResult;
use by\component\aliyun\OSS\Result\CallbackResult;
use by\component\aliyun\OSS\Result\ExistResult;
use by\component\aliyun\OSS\Result\PutLiveChannelResult;
use by\component\aliyun\OSS\Result\GetLiveChannelHistoryResult;
use by\component\aliyun\OSS\Result\GetLiveChannelInfoResult;
use by\component\aliyun\OSS\Result\GetLiveChannelStatusResult;
use by\component\aliyun\OSS\Result\ListLiveChannelResult;
use by\component\aliyun\OSS\Result\AppendResult;
use by\component\aliyun\OSS\Model\ObjectListInfo;
use by\component\aliyun\OSS\Result\SymlinkResult;
use by\component\aliyun\OSS\Result\UploadPartResult;
use by\component\aliyun\OSS\Model\BucketListInfo;
use by\component\aliyun\OSS\Model\LifecycleConfig;
use by\component\aliyun\OSS\Model\RefererConfig;
use by\component\aliyun\OSS\Model\WebsiteConfig;
use by\component\aliyun\OSS\Core\OssUtil;
use by\component\aliyun\OSS\Model\ListPartsInfo;
